#ifndef KISMET_FUZZY_HEDGE_VERY_H
#define KISMET_FUZZY_HEDGE_VERY_H
...
class fuzzy_hedge_very : public fuzzy_term
{
public:
    fuzzy_hedge_very(fuzzy_term_ptr term)
...
#endif // KISMET_FUZZY_HEDGE_VERY_H
